...
Big Data Visualization, Exploratory Data Analysis, Data Visualization Systems
...
\item[] PhD Student,
        ...
        \item I also worked with \href{http://www.cs.arizona.edu/~rts/}{Dr. Richard T. Snodgrass}
        \end{innerlist}
...
\textbf{Gaussian Cubes} (Sep. 2015 to present)
\begin{innerlist}
...
\textbf{ANTARES} (Aug. 2014 to present)
\begin{innerlist}
\item The Arizona-NOAO Temporal Analysis and Response to Events System
\item Architecture Team Member (Aug. 2014 to present)
\item Visualization Team Member (Aug. 2015 to present)
\item Chief Programmer (Aug. 2015 to present)
\end{innerlist}

\halfblankline

\textbf{Obstacle Avoidance System for the Blind} (June 2012 to May 2014 - M.S. Thesis Project)
\begin{innerlist}
\item An electronic travel aid to help the visually impaired walk safely using RGB-D sensors
\item Primary Researcher \& Programmer
\end{innerlist}
...
\begin{innerlist}
\item Propose a novel feature for crowd density estimation: the Local Binary Pattern Co-Occurrence Matrix
\item Primary Researcher \& Programmer
\end{innerlist}
...
%\begin{innerlist}
    %\item Zhe Wang and Carlos Scheidegger. Real-time Interactive Visualization of PCA for Big Data. Preparing for InfoVis 2016.
%\end{innerlist}
...
%\section{Skills}
  ...
  %\textbf{Programming Language}: C/C++, Python, Javascript, C\#, SQL,  \\
  %\textbf{Library and Tools}: D3, Numpy, Scipy, OpenCV, PCL, Matplotlib, Latex, Vim \\
  %\textbf{OS}: OSX, Linux, Windows \\
